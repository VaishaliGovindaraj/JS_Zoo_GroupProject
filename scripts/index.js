...
//mammal objects 
function Animals(groupName, name, lifeSpan, food, description, length, weight, place) {
...
let reptileHawksbillTurtle = new Animals("Reptiles","Hawksbill Turtle", 50,["sponges", "jellyfish","seaplants"], 
    ...
    80,50,"Tropical coasts of Queensland, Northern Territory and Western Australia");
